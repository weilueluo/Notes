...
It is a framework that express information about the resources. It is now commonly used for modeling information about web resource so that it is machine-readable. It provide a standard-compliant way for datasets to interlink, enrich each other and allow cross-dataset queries to be performed.
